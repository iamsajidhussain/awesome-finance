...
> A curated list of tools, platforms, datasets, libraries, research resources, and learning materials for **finance**, spanning personal finance, corporate finance, markets, fintech, quantitative finance, and financial analytics.
...
- [Banking & Financial Infrastructure](#banking--financial-infrastructure)
- [Risk Management](#risk-management)
- [Accounting & Reporting](#accounting--reporting)
- [Financial Data & APIs](#financial-data--apis)
- [Modeling, Analytics & Tools](#modeling-analytics--tools)
...
- [Calcrux](https://calcrux.com/tools/financial) – Free calculators for personal finance and FIRE.
...
- [SWIFT](https://www.swift.com/) – Global financial messaging network.
- [Open Banking](https://www.openbanking.org.uk/) – Standardized APIs for banking data access.
- [Core Banking Systems Overview](https://www.mckinsey.com/industries/financial-services/our-insights/core-banking-modernization) – Architecture and modernization insights.
...
- *Investments & Portfolio Management* – Asset allocation and risk-return tradeoffs.
- *Quantitative Finance* – Mathematical and computational finance methods.
